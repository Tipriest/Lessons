            ...
            if(read(STDIN_FILENO, &input, 1) != -1){
                ...
                switch(msfb_.current_state) {
                    ...
                    case RobotMotionState::StandingUp:
                        if(input=='x') usr_cmd_.target_mode = int(RobotMotionState::ForceStand);
                        if(input=='z') usr_cmd_.target_mode = int(RobotMotionState::SitDown);
                    break;
                    case RobotMotionState::ForceStand:
                    case RobotMotionState::RLControlMode:
                        ...
                        if(current_time - reserved_time_record > 300.) usr_cmd_.reserved_scale = 0;
